...
import { ServicesThumbnailsSettings } from "./ServicesThumbnailsSettings";
            ...
            >
              <IconButton
                ...
                sx={{
                  ...
                  borderRadius: "8px",
                  backgroundColor: theme.palette.background.paper,
                  boxShadow: `0 2px 6px ${alpha(theme.palette.text.primary, 0.10)}`,
                  "&:hover": {
                    backgroundColor: theme.palette.background.paper,
                    boxShadow: `0 3px 8px ${alpha(theme.palette.text.primary, 0.16)}`,
                  },
                }}
              >
                <i
              ...
              >
                {videoMeta?.previewType === "upload" && videoMeta?.inlineUrl ? (
                  ...
                  <iframe
                    ...
                    title={productDetailsData?.name || t("Product Video")}
              ...
              >
                <IconButton
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      backgroundColor: theme.palette.background.paper,
                      boxShadow: `0 3px 8px ${alpha(theme.palette.text.primary, 0.2)}`,
                    },
                  }}
                >
                  <i
      ...
      {allThumbs?.length > 0 && (
        <SliderCustom
          sx={{
            ...
            "& .slick-slide": { height: "auto", padding: "0 4px", maxWidth: "56px" },
            "& .slick-slide > div": { height: "100%" },
          }}
        >
          <Slider {...ServicesThumbnailsSettings}>
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          ...
                          alignItems: "center",
                          justifyContent: "center",
                          boxShadow: `0 2px 6px ${alpha(theme.palette.text.primary, 0.3)}`,
                        }}
                      >
                        <i
...
export default ServiceImageView;
